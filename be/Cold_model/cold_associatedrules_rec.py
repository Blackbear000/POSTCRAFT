...
def associated_rules(inputtext: list[str]):
    ...
    file_path = os.path.join(script_dir, "cold_data.xlsx")
    ...
    if filtered_rules3.empty:
        ...
        return "No matching rules found for the given input features."
...
output = associated_rules(user_input_features3)
